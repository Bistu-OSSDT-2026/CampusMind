...
const owner = 'Bistu-OSSDT-2026';
const repo = 'CampusMind';

const issues = [
  {
    title: '任务 [D1-1]: 项目初始化（Next.js + Prisma + Docker）',
    body: `## 任务信息
...
- 预计完成: 
`,
    assignees: ['jin1120tai'],
    labels: ['项目协调', 'D1', '已完成']
  },
  {
    title: '任务 [D1-2]: 课表模块（CRUD + 可用时段计算）',
    body: `## 任务信息
...
- 预计完成: 
`,
    assignees: ['Dreammaking-cin'],
    labels: ['后端开发', 'D1']
  },
  {
    title: '任务 [D1-3]: 死线模块（CRUD + 倒计时）',
    body: `## 任务信息
...
`,
  ...
  {
    title: '任务 [D1-4]: 聊天界面组件（ChatMessage、ChatInput、Sidebar、MessageList）',
    body: `## 任务信息
...
`,
  ...
  {
    title: '任务 [D2-1]: 对话接口（消息发送/历史/会话管理）',
    body: `## 任务信息
...
`,
  ...
  {
    title: '任务 [D2-3]: 工具编排引擎（B→A→C串联执行）',
    body: `## 任务信息
...
`,
  ...
  {
    title: '任务 [D2-4]: LLM计划生成（提示词 + 结果解析 + 降级）',
    body: `## 任务信息
...
`,
  ...
  {
    title: '任务 [D2-5]: 前端联调（API调用、加载状态、错误处理）',
    body: `## 任务信息
...
`,
  ...
  {
    title: '任务 [D3-2]: Mock数据预置（3门课程 + 3个死线 + 1个考试场景）',
    body: `## 任务信息
...
- 预计完成: 
`,
    assignees: ['Wx114514nm'],
    labels: ['数据处理', 'D3']
  },
  {
    title: '任务 [D3-3]: 演示优化（界面美化、响应式设计、D-N标签）',
    body: `## 任务信息
...
`,
    assignees: ['jin1120tai'],
    labels: ['CI/CD', '文档', 'D3', '已完成']
  },
  {
    title: '任务 [D3-5-1]: 测试部署与版本集成（成员1）',
    body: `## 任务信息
